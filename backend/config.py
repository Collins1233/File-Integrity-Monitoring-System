...
DEV_SESSION_FILE = os.path.join(PROJECT_ROOT, ".fim-dev-session")
...
ENABLE_REALTIME_KERNEL_EVENTS = True
EVENT_DEBOUNCE_DELAY_SECONDS = 0.75
MAX_EVENT_DEBOUNCE_CEILING_SECONDS = 2.5
